...
export default function Home(){
 ...
 return <main>
  ...
  <section className="hero" id="top"><div className="heroText" data-reveal><span className="kicker"><i/> Study abroad support from Harare</span><h1>Discover a university path that <em>fits you.</em></h1><p className="lead">From choosing a course to submitting applications, preparing your visa and booking your flight—Strive helps you move forward with clarity.</p><div className="heroLinks"><a href="#matcher">Find my study options <span>↗</span></a><a href="https://wa.me/263788588061" target="_blank">Talk to a consultant</a></div><div className="supportLine"><b>One guided journey</b><span>Placement</span><span>Application</span><span>Visa</span><span>Flight</span></div></div>
   <div className="profilePreview" aria-hidden="true"><div className="previewTop"><span>YOUR STUDY PROFILE</span><b>Step 1 of 4</b></div><div className="profileRow active"><i>01</i><span><small>What do you want to study?</small><b>Choose your field</b></span><strong>›</strong></div><div className="profileRow"><i>02</i><span><small>Where would you like to go?</small><b>Select a destination</b></span><strong>›</strong></div><div className="profileRow"><i>03</i><span><small>What is your study level?</small><b>Undergraduate or postgraduate</b></span><strong>›</strong></div><div className="profileRow"><i>04</i><span><small>What is your academic background?</small><b>Add your latest qualification</b></span><strong>›</strong></div><div className="previewNote"><span>STRIVE</span><p>We use your answers to guide a personal consultation—never to promise automatic admission.</p></div></div>
  </section>
  ...
  <section className="process" id="process"><div className="processHead" data-reveal><span>HOW IT WORKS</span><h2>From uncertainty to<br/><em>a clear next step.</em></h2><p>There is a lot to coordinate when you study abroad. We break it into a sequence you can understand and act on.</p></div><div className="steps">{steps.map((s,i)=><article key={s[1]} data-reveal><b>{s[0]}</b><div><span>{i===0?"BEGIN HERE":i===4?"READY TO GO":"KEEP MOVING"}</span><h3>{s[1]}</h3><p>{s[2]}</p></div><i>↗</i></article>)}</div></section>
